...
| R22 | 1 | 15 k, 1 %, 0.25 W, metal film, THT | `MFR-25FBF52-15k` | Reichelt / Mouser | 0.10 | PWR-K: D20 to STAT2 (CHG_N): charging pulls the node to 2.09-2.46 V (worst case including the STAT pins' VOL, SLUSF65B 5.5; at 0.28 mA of sink current, far below the 5 mA that figure is given for). |
| R23 | 1 | 3.3 k, 1 %, 0.25 W, metal film, THT | `MFR-25FBF52-3.3k` | Reichelt / Mouser | 0.10 | PWR-K: D21 to STAT1 (FLT_N): a fault pulls the node to 1.02-1.60 V (worst case including VOL). |
